...
MAIN: ' 
    ...
    A_old = A
	'根据变量的值条件转移,A=0跳转到MAIN，A=1跳转到KEY1...
...
KEY4:
    GOSUB left_ball_kick
    GOTO main
    
KEY5:
    GOSUB right_ball_kick
    GOTO main  
...
'
'KEY1:
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        info_index = 0	'KOREA-韩国
'        GOSUB RBNV_info_1m9s	'跳转到子程序
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN	
'            GOSUB bow_1	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOSUB scissors	'跳转到子程序
'        ENDIF
'
'    ELSEIF  Action_mode  = 3 THEN ' footballmode-足球模式
'
'        IF pose = 0 THEN
'            GOSUB keeper_left	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 4 THEN ' steeplechase_racesmode-障碍赛跑模式
'        IF thing_chach_pose = 0 AND pose = 0 THEN
'            GOSUB stair_left_up_3cm	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 5 THEN ' cameramode-视觉模式
'        IF pose = 0 THEN
'            GOSUB flyingpose	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 6 THEN ' MFpromote-MF升级模式盖
'        IF pose = 0 THEN
'
'            GOSUB SOUND_promote1	'跳转到子程序
'            GOSUB RND_MOTION	'跳转到子程序
'        ENDIF
'
'    ENDIF
'
...
'    ELSEIF  Action_mode  = 3 THEN ' footballmode-足球模式
'        IF pose = 0 THEN	
'            GOSUB keeper_front	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 4 THEN ' steeplechase_racesmode-障碍赛跑模式
'        IF pose = 0 THEN
'            IF thing_chach_pose = 0 THEN
'                GOTO front_short_step	'跳转到标签
'            ELSE
'                GOTO chach_run	'跳转到标签
'            ENDIF
'        ENDIF
'    ELSEIF  Action_mode  = 5 THEN ' cameramode-视觉模式
'        IF pose = 0 THEN
'            GOSUB fighter_pose	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 6 THEN ' MFpromote-MF升级模式
'        IF thing_chach_pose = 0 AND pose = 0 THEN
'
'            GOSUB SOUND_promote2	'跳转到子程序
'            GOSUB RND_MOTION	'跳转到子程序
'        ENDIF
'
'    ENDIF
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'          IF pose = 0 THEN	
'            info_index = 2 'JAPAN-日本
'            GOSUB RBNV_info_1m9s	'跳转到子程序
'        ENDIF
'
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOSUB comeon_action	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOSUB paper	'跳转到子程序
...
'    ELSEIF  Action_mode  = 3 THEN ' footballmode-足球模式
'        IF pose = 0 THEN
'            GOSUB keeper_right	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 4 THEN ' steeplechase_racesmode-障碍赛跑模式
'        IF thing_chach_pose = 0 AND pose = 0 THEN
'            GOSUB stair_right_up_3cm	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 5 THEN ' cameramode-视觉模式
'        IF pose = 0 THEN
'            GOSUB side_attack_pose	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 6 THEN ' MFpromote-MF升级模式
'
'        IF pose = 0 THEN
'            GOSUB SOUND_promote3	'跳转到子程序
'            GOSUB RND_MOTION	'跳转到子程序
'
'        ENDIF
'    ENDIF
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            info_index = 3 'English-英国
'            GOSUB RBNV_info_1m9s	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOSUB win_ceremony_1	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOSUB blue_left_up	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 3 THEN ' footballmode-足球模式
'        IF pose = 0 THEN
'            GOSUB throwing_left	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 4 THEN ' steeplechase_racesmode-障碍赛跑模式
'        IF thing_chach_pose = 0 AND pose = 0 THEN
'            GOSUB stair_left_down_3cm	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 5 THEN ' cameramode-视觉模式
'        IF pose = 0 THEN
'            GOSUB one_foot_up_pose	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 6 THEN ' MFpromote-MF升级模式
'        IF thing_chach_pose = 0 AND pose = 0 THEN
'            GOSUB SOUND_promote4	'跳转到子程序
'            GOSUB RND_MOTION	'跳转到子程序
'        ENDIF
'
'    ENDIF
...
'        IF pose = 0 THEN
'            'GOSUB old_dance	'13
'            GOSUB flying	'24		'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOSUB win_ceremony_2	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOSUB cham3game	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 3 THEN ' footballmode-足球模式
'        IF pose = 0 THEN
'            GOSUB throwing_front	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 4 THEN ' steeplechase_racesmode-障碍赛跑模式
'        IF thing_chach_pose = 0 AND pose = 0 THEN
'            GOSUB dice_game	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 5 THEN ' cameramode-视觉模式
'        IF pose = 0 THEN
'            GOSUB ball_kick_pose	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 6 THEN ' MFpromote-MF升级模式
'        IF thing_chach_pose = 0 AND pose = 0 THEN
'            GOSUB SOUND_promote5	'跳转到子程序
'            GOSUB RND_MOTION	'跳转到子程序
'        ENDIF
'
'    ENDIF
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOSUB back_dancer2	'11	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOSUB win_ceremony_3	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOSUB white_right_up	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 3 THEN ' footballmode-足球模式
'        IF pose = 0 THEN
'            GOSUB throwing_right	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 4 THEN ' steeplechase_racesmode-障碍赛跑模式
'        IF thing_chach_pose = 0 AND pose = 0 THEN
'            GOSUB stair_right_down_3cm	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 5 THEN ' cameramode-视觉模式
'        IF pose = 0 THEN
'            GOSUB vision_pose	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 6 THEN ' MFpromote-MF升级模式
'        IF thing_chach_pose = 0 AND pose = 0 THEN
'            GOSUB SOUND_promote6	'跳转到子程序
'            GOSUB RND_MOTION	'跳转到子程序
'        ENDIF
'
'    ENDIF
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOSUB breathing_exercises	'6	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOSUB lose_action_1	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOSUB blue_left_down	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 3 THEN ' footballmode-足球模式
'        IF pose = 0 THEN
'            GOTO left_turn_10	'跳转到标签
'        ENDIF
'    ELSEIF  Action_mode  = 4 THEN ' steeplechase_racesmode-障碍赛跑模式
'        IF thing_chach_pose = 0 AND pose = 0 THEN
'            GOTO crawlleft_turn_	'跳转到标签
'        ENDIF
'    ELSEIF  Action_mode  = 5 THEN ' cameramode-视觉模式
'        IF pose = 0 THEN
'            GOSUB old_dancepose	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 6 THEN ' MFpromote-MF升级模式
'        IF thing_chach_pose = 0 AND pose = 0 THEN
'            GOSUB SOUND_promote7	'跳转到子程序
'            GOSUB RND_MOTION	'跳转到子程序
'        ENDIF
'    ENDIF
'
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOSUB LR_twist_dance	'12	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOSUB hug_action	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOSUB dice_game	'跳转到子程序
...
'    ELSEIF  Action_mode  = 5 THEN ' cameramode-视觉模式
'        IF pose = 0 THEN
'            GOSUB walkpose	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 6 THEN ' MFpromote-MF升级模式
'        IF thing_chach_pose = 0 AND pose = 0 THEN
'            GOSUB SOUND_promote8	'跳转到子程序
'            GOSUB RND_MOTION	'跳转到子程序
'        ENDIF
'    ENDIF
'
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOSUB fly_standup	'7	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOSUB lose_action_2	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOSUB white_right_down	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 3 THEN ' footballmode-足球模式
'        IF pose = 0 THEN
'            GOTO right_turn_10	'跳转到标签
'        ENDIF
'    ELSEIF  Action_mode  = 4 THEN ' steeplechase_racesmode-障碍赛跑模式
'        IF thing_chach_pose = 0 AND pose = 0 THEN
'            GOTO crawlright_turn_	'跳转到标签
'        ENDIF
'    ELSEIF  Action_mode  = 5 THEN ' cameramode-视觉模式
'        IF pose = 0 THEN
'            GOSUB Imsorry_pose	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 6 THEN ' MFpromote-MF升级模式
'        IF thing_chach_pose = 0 AND pose = 0 THEN
'            GOSUB SOUND_promote9	'跳转到子程序
'            GOSUB RND_MOTION	'跳转到子程序
'        ENDIF	
'
'    ENDIF
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOSUB bbong_song_dance	'12	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOTO front_LR_punch	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOSUB cup_throw_game	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 3 THEN ' footballmode-足球模式
'        IF pose = 0 THEN
'            GOTO front_short_step	'跳转到标签
...
'        IF pose = 0 THEN
'            IF thing_chach_pose = 0 THEN
'                GOSUB  thing_catch	'跳转到子程序
'            ELSE
'                GOSUB thing_drop	'跳转到子程序
'            ENDIF
'        ENDIF
'    ELSEIF  Action_mode  = 5 THEN ' cameramode-视觉模式
'        IF pose = 0 THEN
...
'    ELSEIF  Action_mode  = 6 THEN ' MFpromote-MF升级模式
'        IF  pose = 0 THEN
'            IF thing_chach_pose = 2 THEN
'                GOTO paper_lift_front_walk_50	'跳转到标签
'            ELSE
'                GOTO front_walk_50	'跳转到标签
'            ENDIF
'        ENDIF
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOTO back_walk_50	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOTO back_run_40	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOTO back_run_40	'跳转到标签
...
'                GOTO back_run_40	'跳转到标签
'            ELSE
'                GOTO back_sit_walk	'跳转到标签
'            ENDIF
'        ELSE
'            IF pose = 0 THEN
'                GOTO chach_back_walk	'跳转到标签
'            ELSE
'                GOTO back_sit_walk	'跳转到标签
'            ENDIF		
'        ENDIF
...
'        ENDIF
'    ELSEIF  Action_mode  = 6 THEN ' MFpromote-MF升级模式
'        IF  pose = 0 AND thing_chach_pose = 0 THEN
'            GOTO back_walk_50	'跳转到标签
'        ENDIF
'
'    ENDIF
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOSUB slow_right_walk_50	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOTO right_walk_70	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOTO right_walk_70	'跳转到标签
...
'                GOTO right_walk_70	'跳转到标签	
'            ELSE
'                GOTO sit_right_walk	'跳转到标签
'            ENDIF
'        ELSE
'            IF pose = 0 THEN
'                GOTO chack_right_walk_70	'跳转到标签
'            ELSE
'                GOTO sit_right_walk	'跳转到标签
'            ENDIF		
'        ENDIF
...
'        ELSE
'            IF pose = 0 THEN
'                GOTO chack_right_walk_20	'跳转到标签
'            ENDIF		
'        ENDIF
'    ENDIF
'
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOSUB  slow_left_walk_50	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOTO left_walk_70	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOTO left_walk_70	'跳转到标签
...
'                GOTO left_walk_70	'跳转到标签
'            ELSE
'                GOTO sit_left_walk	'跳转到标签
'            ENDIF
'        ELSE
'            IF pose = 0 THEN
'                GOTO chack_left_walk_70	'跳转到标签	
'            ELSE
'                GOTO sit_left_walk	'跳转到标签
'            ENDIF		
'        ENDIF
...
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOTO left_front_attack	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOSUB left_ball_kick	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 3 THEN ' footballmode-足球模式
'        IF pose = 0 THEN
'            GOSUB left_ball_kick	'跳转到子程序
...
'    GOSUB MOTOR_OFF	'跳转到子程序
'    GOSUB GOSUB_RX_EXIT	'跳转到子程序
'
'KEY16_1:
'
'    GOSUB motor_ONOFF_LED	'跳转到子程序	
'
'    ERX 4800,A,KEY16_1	'速度为4800，端口为A获取信息
'    GOSUB SOUND_STOP	'跳转到子程序
'    '****    ****
'    IF motor_ONOFF = 1 AND A <> 16 THEN
'        GOSUB MOTOR_FAST_ON	'跳转到子程序
'        GOSUB All_motor_mode3	'跳转到子程序
'    ENDIF
'    IF A = 16 THEN		'
'        IF motor_ONOFF = 1 THEN
'            GOSUB MOTOR_ON	'跳转到子程序
'        ELSE
'            GOSUB MOTOR_OFF	'跳转到子程序
'        ENDIF
'    ELSEIF A = 27 OR A = 1 THEN	'D :dancemode-舞蹈模式
'        Action_mode  = 0
'        GOSUB SOUND_dancemode	'跳转到子程序
'        SPEED 10	'电机速度10
'        MOVE G6B,, 50, 90	'操作G6B电机组
'        MOVE G6C,, 50, 90	'操作G6C电机组
'        WAIT
'
'        SPEED 10			'电机速度10
'        MOVE G6A,100,  76, 145,  93, 100, 100	'操作G6A电机组
'        MOVE G6D,100,  76, 145,  93, 100, 100	'操作G6D电机组
'        MOVE G6B,100, 70, 30, , , 100			'操作G6B电机组
'        MOVE G6C,100, 70, 30					'操作G6C电机组
'        WAIT
'        'GOSUB entertainment_sound
'    ELSEIF A = 32 OR A = 2  THEN	'F :fightmode-竞技模式
'        Action_mode  = 1
'        GOSUB SOUND_拜捧mode	'跳转到子程序
'        SPEED 10				'电机速度10
'        MOVE G6B,, 60, 90		'操作G6B电机组
'        MOVE G6C,, 60, 90		'操作G6C电机组
'        WAIT     				'等待动作完成
'
'        SPEED 8									'电机速度8
'        MOVE G6A,100,  76, 145,  93, 100, 100	'操作G6A电机组
'        MOVE G6D,100,  76, 145,  93, 100, 100	'操作G6D电机组
'        MOVE G6B,188, 15, 20, , , 100			'操作G6B电机组
'        MOVE G6C,188, 20, 90					'操作G6C电机组
'        WAIT									'等待动作完成
'        'GOSUB fight_sound
'    ELSEIF A = 23 OR A = 3  THEN	'G :gamemode-游戏模式
'        Action_mode  = 2
'        GOSUB SOUND_gamemode		'跳转到子程序
'        SPEED 10					'电机速度10
'        MOVE G6B,, 60, 90			'操作G6B电机组
'        MOVE G6C,, 60, 90			'操作G6C电机组
'        WAIT						'等待动作完成     	
...
'        MOVE G6A,100,  76, 145,  93, 100, 100	'操作G6A电机组
'        MOVE G6D,100,  76, 145,  93, 100, 100	'操作G6D电机组
'        MOVE G6B,170, 20, 80, , , 100			'操作G6B电机组
'        MOVE G6C,140, 20, 80					'操作G6C电机组
'        WAIT									'等待动作完成     	
'        'GOSUB game_sound
'    ELSEIF A = 20 OR A = 4  THEN	'B :footballmode-足球模式
'        Action_mode  = 3
'        GOSUB SOUND_footballmode	'跳转到子程序
'        SPEED 10					'电机速度10
'        MOVE G6B,, 60, 90			'操作G6B电机组
'        MOVE G6C,, 60, 90			'操作G6C电机组
'        WAIT						'等待动作完成       	
'
'        SPEED 10					'电机速度10
'        MOVE G6A,93,  76, 145,  93, 105, 100	'操作G6A电机组
'        MOVE G6D,105,  76, 145,  93, 96, 100	'操作G6D电机组
'        MOVE G6B,70, 35, 80, , , 100			'操作G6B电机组
'        MOVE G6C,140, 35, 80					'操作G6C电机组
'        WAIT									'等待动作完成
'        'GOSUB footballgame_sound
'    ELSEIF A = 18 OR A = 5  THEN	'E :steeplechase_racesmode-障碍赛跑模式
'        Action_mode  = 4
'        GOSUB SOUND_steeplechase_racesmode		'跳转到子程序
'        SPEED 10				'电机速度10
'        MOVE G6B,, 60, 90		'操作G6B电机组
'        MOVE G6C,, 60, 90		'操作G6C电机组
'        WAIT					'等待动作完成     	
'
'        SPEED 6					'电机速度6
'        MOVE G6A,100,  71, 145,  113, 100, 100	'操作G6A电机组
'        MOVE G6D,100,  71, 145,  113, 100, 100	'操作G6D电机组
'        MOVE G6B,70, 25, 80, , , 100			'操作G6B电机组
'        MOVE G6C,70, 25, 80						'操作G6C电机组
'        WAIT									'等待动作完成
'        'GOSUB steeplechase_racesmode_sound
'    ELSEIF A = 17 OR A = 6  THEN ' C: cameramode-视觉模式
'        Action_mode  = 5
'        GOSUB SOUND_cameramode
'        SPEED 10				'电机速度10
'        MOVE G6B,100, 60, 90	'操作G6B电机组
'        MOVE G6C,100, 60, 90	'操作G6C电机组
'        WAIT					'等待动作完成    	
'
'        SPEED 10				'电机速度10
'        MOVE G6A,100,  76, 145,  93, 100, 100	'操作G6A电机组
'        MOVE G6D,100,  76, 145,  93, 100, 100	'操作G6D电机组
'        MOVE G6B,140, 30, 30, , , 80			'操作G6B电机组
'        MOVE G6C,140, 30, 30					'操作G6C电机组
'        WAIT									'等待动作完成
'    ELSEIF A = 15 OR A = 7  THEN	'A : promotemode-升级模式
'        Action_mode  = 6
'        GOSUB SOUND_promotemode		'跳转到子程序
'        SPEED 10					'电机速度10
'        MOVE G6B,, 55, 90			'操作G6B电机组
'        MOVE G6C,, 55, 90			'操作G6C电机组
'        WAIT						'等待动作完成     	
'
'        SPEED 10					'电机速度10
'        MOVE G6A,100,  76, 145,  93, 100, 100	'操作G6A电机组	
'        MOVE G6D,100,  76, 145,  93, 100, 100	'操作G6D电机组
'        MOVE G6B,160, 70, 90, , , 60			'操作G6B电机组
'        MOVE G6C,180, 30, 20					'操作G6C电机组
'        WAIT									'等待动作完成
'        'GOSUB start_buzzer
'
'    ELSEIF A = 26 THEN	'♂ : 
'        GOSUB MOTOR_FAST_ON						'跳转到子程序
'        SPEED 5									'电机速度5
'        MOVE G6A,97,  76, 145,  93, 102, 100	'操作G6A电机组
'        MOVE G6D,97,  76, 145,  93, 102, 100	'操作G6D电机组
'        WAIT									'等待动作完成
'        SPEED 8									'电机速度8
'        MOVE G6B,, 50, 90, , , 100	'操作G6B电机组
'        MOVE G6C,, 50, 90			'操作G6C电机组
'        WAIT						'等待动作完成
'        GOSUB standard_pose			'跳转到子程序
'        'GOSUB start_buzzer
'
'        GOSUB All_motor_Reset		'跳转到子程序
'        GOSUB SOUND_MODE_SELECT		'跳转到子程序
'        GOTO RX_EXIT				'跳转到标签
'
'
'    ELSEIF A = 21 THEN 	' 
'        GOSUB SOUND_ALL_ON_MSG		'跳转到子程序
'    ELSEIF A = 31 THEN  ' 
'        GOSUB SOUND_ALL_OFF_MSG		'跳转到子程序
'    ELSEIF A = 30 THEN  '
'        GOSUB SOUND_BGM2			'跳转到子程序
'        GOSUB SOUND_UP				'跳转到子程序
'        GOSUB buzzer_sound			'跳转到子程序
'    ELSEIF A = 28 THEN  ' 
'        GOSUB SOUND_BGM2			'跳转到子程序
'        GOSUB SOUND_DOWN		
'        GOSUB buzzer_sound			'跳转到子程序
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOSUB continuous_dance_1	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOTO left_side_back_attack	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOTO penalty_left			'跳转到标签
'        ENDIF
'    ELSEIF  Action_mode  = 3 THEN ' footballmode-足球模式
'        IF pose = 0 THEN
'            GOSUB left_shoot		'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 4 THEN ' steeplechase_racesmode-障碍赛跑模式
'        IF thing_chach_pose = 0 AND pose = 0 THEN
'            GOTO penalty_left		'跳转到标签
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOSUB total_dance_1	'跳转到子程序
'
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOTO left_walk_20	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOSUB left_side_up	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 3 THEN ' footballmode-足球模式
'        IF pose = 0 THEN
'            GOTO penalty_left	'跳转到标签
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOTO right_turn_45	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOTO right_turn_60	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOTO right_turn_45	'跳转到标签
...
'        ELSE
'            IF pose = 0 THEN
'                GOTO chack_right_turn_45	'跳转到标签		
'            ENDIF		
'        ENDIF
'    ELSEIF  Action_mode  = 5 THEN ' cameramode-视觉模式
'        IF pose = 0 THEN
...
'        IF thing_chach_pose = 0 THEN
'            IF pose = 0 THEN
'                GOTO right_turn_20		'跳转到标签
'            ENDIF
'        ELSE
'            IF pose = 0 THEN
'                GOTO chack_right_turn_20	'跳转到标签		
'            ENDIF		
'        ENDIF
'
'    ENDIF
...
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOTO right_front_attack	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'
'            GOSUB right_ball_kick	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 3 THEN ' footballmode-足球模式
'        IF pose = 0 THEN
'            GOSUB right_ball_kick	'跳转到子程序
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOSUB front_tumbling	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOTO front_lift_attack	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOTO front_run_30		'跳转到标签
'        ENDIF
'    ELSEIF  Action_mode  = 3 THEN ' footballmode-足球模式
'        IF pose = 0 THEN
'            GOTO front_short_step		'跳转到标签
...
'        IF pose = 0 THEN
'
'            GOSUB hand_standing	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOTO left_turn_20	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOTO left_turn_10	'跳转到标签
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOSUB people_gym_start'total_dance_3'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOTO right_walk_20	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOSUB right_side_up	'跳转到子程序
'        ENDIF
'    ELSEIF  Action_mode  = 3 THEN ' footballmode-足球模式
'        IF pose = 0 THEN
'            GOTO penalty_right	'跳转到标签	
'        ENDIF
'    ELSEIF  Action_mode  = 4 THEN ' steeplechase_racesmode-障碍赛跑模式
'        GOSUB front_standup	'跳转到子程序
'        GOTO RX_EXIT		'跳转到标签
'
'    ELSEIF  Action_mode  = 5 THEN ' cameramode-视觉模式
'        IF pose = 0 THEN
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOTO left_turn_45	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOTO left_turn_60	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOTO left_turn_45	'跳转到标签
...
'KEY26: ' ♂
'    GOSUB SOUND_STOP
'    IF pose = 1 THEN GOTO RX_EXIT	'跳转到标签
'
...
'
'        ELSE
'            GOSUB Arm_motor_mode3	'跳转到子程序
'            SPEED 10				'电机速度10
'            MOVE G6B, , 60			'操作G6B电机组
'            MOVE G6C, , 60			'操作G6C电机组
'            WAIT					'等待动作完成	
'            SPEED 8					'电机速度8
'            GOSUB standard_pose		'跳转到子程序	
'        ENDIF
...
'    ENDIF
'
'    S7 = MOTORIN(7)		'读取7号电机位置
'    S8 = MOTORIN(8)		'读取8号电机位置
'    S13 = MOTORIN(13)	'读取13号电机位置
'    S14 = MOTORIN(14)	'读取14号电机位置
'
'    IF S7 < 25 OR S8 < 40 THEN
'        SPEED 4					'电机速度4
'        MOVE G6B,,  50,  100	'操作G6B电机组
'        MOVE G6C,,  50,  100	'操作G6C电机组
'        WAIT					'等待动作完成
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOSUB continuous_dance_2	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOTO right_side_back_attack	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOTO penalty_right	'跳转到标签
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOSUB left_tumbling	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOTO left_side_attack	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOTO left_walk_20	'跳转到标签
...
'        GOSUB SOUND_BGM1	'跳转到子程序
'        GOSUB standstill	'跳转到子程序
'        GOSUB SOUND_STOP	'跳转到子程序
'        GOTO RX_EXIT		'跳转到标签
'    ENDIF
'
...
'        IF pose = 0 THEN
'            IF  thing_chach_pose = 0 THEN
'                GOSUB Leg_motor_mode3	'跳转到子程序
'
'                SPEED 10								'电机速度10
'                MOVE G6A,100, 140,  37, 140, 100, 100	'操作G6A电机组
'                MOVE G6D,100, 140,  37, 140, 100, 100	'操作G6D电机组
'                WAIT									'等待动作完成	
'
'                SPEED 3									'电机速度3
'                GOSUB sit_pose							'跳转到子程序	
'            ELSE
'                GOSUB Leg_motor_mode3					'跳转到子程序
'
'                SPEED 10								'电机速度10
...
'
'                SPEED 3									'电机速度3
'                MOVE G6A,100, 140,  28, 142, 100, 100	'操作G6A电机组
'                MOVE G6D,100, 140,  28, 142, 100, 100	'操作G6D电机组
'                WAIT									'等待动作完成	
'                pose = 1		
'            ENDIF
'
...
'
'                SPEED 10								'电机速度10
'                MOVE G6A,100,  76, 145,  85, 100		'操作G6A电机组
'                MOVE G6D,100,  76, 145,  85, 100		'操作G6D电机组
'                WAIT									'等待动作完成
'                pose = 0
'                GOSUB Leg_motor_mode1					'跳转到子程序	
'            ENDIF
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOSUB right_tumbling	'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOTO right_side_attack	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOTO right_walk_20	'跳转到标签
...
'    IF Action_mode  = 0 THEN 'dancemode-舞蹈模式
'        IF pose = 0 THEN
'            GOSUB back_tumbling		'跳转到子程序
'        ENDIF
'    ELSEIF Action_mode  = 1 THEN 'fightmode-竞技模式
'        IF pose = 0 THEN
'            GOTO back_lift_attack	'跳转到标签
'        ENDIF
'    ELSEIF Action_mode  = 2 THEN 'gamemode-游戏模式
'        IF pose = 0 THEN
'            GOTO crawl				'跳转到标签
